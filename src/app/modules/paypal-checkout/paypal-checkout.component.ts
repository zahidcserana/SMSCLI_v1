...
import { validateCard, createYearArray, monthsArray, getBillingInfo } from '../../globals/_classes/functions';
...
export class PaypalCheckoutComponent implements OnInit {
  ...
  submitPaypal() {
    ...
    this.onSelectPayment.emit({card: this.paymentInfo, payment_gateway_name: 'PayPal'});
  }
